...
GO
ALTER TABLE [dbo].[IssueList] ALTER COLUMN [Category] INT NOT NULL;

ALTER TABLE [dbo].[IssueList] ALTER COLUMN [Severity] BIT NOT NULL;

ALTER TABLE [dbo].[IssueList] ALTER COLUMN [Status] INT NOT NULL;
