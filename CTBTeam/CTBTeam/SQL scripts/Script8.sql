...
GO
ALTER TABLE [dbo].[IssueList] DROP CONSTRAINT [DF__IssueList__Activ__15702A09];
...
GO
/*
The column [dbo].[IssueList].[Proj_ID] on table [dbo].[IssueList] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
GO
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        ...
        INSERT INTO [dbo].[tmp_ms_xx_IssueList] ([Id], [Category], [Severity], [Title], [Due_Date], [Status], [Updated], [Reporter], [Assignee], [Active], [Description], [Comment])
        SELECT   [Id],
                 [Category],
                 [Severity],
                 [Title],
